...
namespace GitHubAutomation.Steps
{
    public class Steps
    {
        ...
        public static string GenerateRandomRepositoryNameWithCharLength(int howManyChars)
        {
            string repositoryNamePrefix = "testRepo_";
            return string.Concat(repositoryNamePrefix, Utilities.RandomGenerator.GetRandomString(howManyChars));
        }
